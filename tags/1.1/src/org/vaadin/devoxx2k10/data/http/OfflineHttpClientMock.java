...
public class OfflineHttpClientMock implements HttpClient {
    ...
    private static final String TEST_JSON_SEARCH = "[{\"tags\":[{\"name\":\"closures\"},{\"name\":\"Java7\"},{\"name\":\"Java8\"}],\"summary\":\"This talk introduces a little tool that mixes a dash of functional flavour into Java 6. With jcurry (http://jcurry.org), most class members can be made into first-class curried functions with just the addition of an annotation. This talk will present the concept with some simple examples, delve just a little into how it works, and explore how it all relates to the wider context of programming style and Java 7 closures.\",\"id\":157,\"speakerUri\":\"http://cfp.devoxx.com/rest/v1/events/speakers/138\",\"title\":\"First class curried members with jcurry\",\"speaker\":\"George Svarovsky\",\"track\":\"Java Core (SE/EE)\",\"experience\":\"SENIOR\",\"speakers\":[{\"speakerUri\":\"http://cfp.devoxx.com/rest/v1/events/speakers/138\",\"speaker\":\"George Svarovsky\"}],\"type\":\"Quickie (15m)\"},{\"tags\":[{\"name\":\"javase\"},{\"name\":\"modules\"},{\"name\":\"closures\"},{\"name\":\"Java7\"},{\"name\":\"Java8\"}],\"summary\":\"During this keynote you'll get an overview of the state of Java SE 7 and beyond.\",\"id\":333,\"speakerUri\":\"http://cfp.devoxx.com/rest/v1/events/speakers/279\",\"title\":\"Java SE: The Road Ahead\",\"speaker\":\"Mark Reinhold\",\"track\":\"Java Core (SE/EE)\",\"experience\":\"SENIOR\",\"speakers\":[{\"speakerUri\":\"http://cfp.devoxx.com/rest/v1/events/speakers/279\",\"speaker\":\"Mark Reinhold\"}],\"type\":\"Conference (1h)\"}]";
    ...
    public HttpResponse get(final String urlString) throws IOException {
        ...
        } else if (urlString.startsWith("http://cfp.devoxx.com/rest/v1/events/1/presentations/search")) {
            return new HttpResponse(HttpURLConnection.HTTP_OK, TEST_JSON_SEARCH);
